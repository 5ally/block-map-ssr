...
const Edit = ({
  ...
  const mapContainer = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const [mapLoaded, setMapLoaded] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  })), accessToken && !mapLoaded && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", null, "Loading map.."), accessToken && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("iframe", {
...
const save = ({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "loading"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", null, "Loading map..")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: 'map',
    style: {
      height: '300px'
    },
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"tda/block-map-ssr","version":"0.1.0","title":"Mapbox GL JS demo (SSR)","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","supports":{"html":false,"multiple":false},"textdomain":"tda-map","editorScript":"file:./index.js","style":["file:./style-index.css","mapbox-gl"],"viewScript":["file:./view.js","mapbox-gl"],"attributes":{"accessToken":{"type":"string","default":"","source":"attribute","selector":"div#map","attribute":"data-token"}}}');
